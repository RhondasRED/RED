    ...
    def plot(self):
            ...
            for key, structure in RTstructures1.items():
                ...
                if (key in calcdvhs1) and (structure['name']== enteredtext) and (len(calcdvhs1[key].counts) and calcdvhs1[key].counts[0]!=0):
                    ...
                    dvhdata1 = np.array(calcdvhs1[key].bins)
            ...
            if plan1files >=2:
                for key, structure in RTstructures1.items():
                    ...
                    if (key in calcdvhs2) and (structure['name']== enteredtext) and (len(calcdvhs2[key].counts) and calcdvhs2[key].counts[0]!=0):
                        ...
                        dvhdata2 = np.array(calcdvhs2[key].bins)
            ...
            if plan1files >=3:
                for key, structure in RTstructures1.items():
                    ...
                    if (key in calcdvhs3) and (structure['name']== enteredtext) and (len(calcdvhs3[key].counts) and calcdvhs3[key].counts[0]!=0):
                        ...
                        dvhdata3 = np.array(calcdvhs3[key].bins)
            ...
            if plan1files >=4:
                for key, structure in RTstructures1.items():
                    ...
                    if (key in calcdvhs4) and (structure['name']== enteredtext) and (len(calcdvhs4[key].counts) and calcdvhs4[key].counts[0]!=0):
                        ...
                        dvhdata4 = np.array(calcdvhs4[key].bins)
            ...
            if plan2files >=1:
                for key, structure in RTstructures1.items():
                    ...
                    if (key in calcdvhs5) and (structure['name']== enteredtext) and (len(calcdvhs5[key].counts) and calcdvhs5[key].counts[0]!=0):
                        ...
                        dvhdata5 = np.array(calcdvhs5[key].bins)
            ...
            if plan2files >=2:
                for key, structure in RTstructures1.items():
                    ...
                    if (key in calcdvhs6) and (structure['name']== enteredtext) and (len(calcdvhs6[key].counts) and calcdvhs6[key].counts[0]!=0):
                        ...
                        dvhdata6 = np.array(calcdvhs6[key].bins)
            ...
            if plan2files >=3:
                for key, structure in RTstructures1.items():
                    ...
                    if (key in calcdvhs7) and (structure['name']== enteredtext) and (len(calcdvhs7[key].counts) and calcdvhs7[key].counts[0]!=0):
                        ...
                        dvhdata7 = np.array(calcdvhs7[key].bins)
            ...
            if plan2files >=4:
                for key, structure in RTstructures1.items():
                    ...
                    if (key in calcdvhs8) and (structure['name']== enteredtext) and (len(calcdvhs8[key].counts) and calcdvhs8[key].counts[0]!=0):
                        ...
                        dvhdata8 = np.array(calcdvhs8[key].bins)
            ...
            volumedata1 = vola
            volumedata5 = vole
            dosedata1 = dvhdata1 * x1
            dosedata5 = dvhdata5 * x2

            if plan1files ==2:
                dosedata2 = dvhdata2 * x1
                volumedata2 = volb
            elif plan1files ==3:
                dosedata2 = dvhdata2* x1
                volumedata2 = volb
                dosedata3 = dvhdata3 * x1
                volumedata3 = volc
            elif plan1files ==4:
                dosedata2 = dvhdata2 * x1
                volumedata2 = volb
                dosedata3 = dvhdata3 * x1
                volumedata3 = volc
                dosedata4 = dvhdata4 * x1
                volumedata4 = vold
            else:
                print("Only 1 dose file for plan 1")

            if plan2files ==2:
                dosedata6 = dvhdata6 * x2
                volumedata6 = volf
            elif plan2files ==3:
                dosedata6 = dvhdata6 * x2
                volumedata6 = volf
                dosedata7 = dvhdata7 * x2
                volumedata7 = volg
            elif plan2files ==4:
                dosedata6 = dvhdata6 * x2
                volumedata6 = volf
                dosedata7 = dvhdata7 * x2
                volumedata7 = volg
                dosedata8 = dvhdata8 * x2
                volumedata8 = volh
            else:
                print("Only 1 dose file for plan 2")
            ...
            delta13 = (len(inp13)-1) / float(new_len-1)
            outp13 = [interpolate(inp13, i*delta13) for i in range(new_len)]

            if plan1files ==2:
                delta2 = (len(inp2)-1) / float(new_len-1)
                outp2 = [interpolate(inp2, i*delta2) for i in range(new_len)]
                delta10 = (len(inp10)-1) / float(new_len-1)
                outp10 = [interpolate(inp10, i*delta10) for i in range(new_len)]   
                ...
                delta11 = (len(inp11)-1) / float(new_len-1)
                outp11 = [interpolate(inp11, i*delta11) for i in range(new_len)]
                ...
                delta12 = (len(inp12)-1) / float(new_len-1)
                outp12 = [interpolate(inp12, i*delta12) for i in range(new_len)]
            else:
                print("Plan 1 dose interpolated")

            if plan2files ==2:
                delta7 = (len(inp7)-1) / float(new_len-1)
                outp7 = [interpolate(inp7, i*delta7) for i in range(new_len)] 
                delta14 = (len(inp14)-1) / float(new_len-1)
                outp14 = [interpolate(inp14, i*delta14) for i in range(new_len)]            
                ...
                delta15 = (len(inp15)-1) / float(new_len-1)
                outp15 = [interpolate(inp15, i*delta15) for i in range(new_len)]
                ...
                delta16 = (len(inp16)-1) / float(new_len-1)
                outp16 = [interpolate(inp16, i*delta16) for i in range(new_len)]
            else:
                print("Plan 2 dose interpolated")

            if plan1files ==1:
                interxvaluesplan1a = outp1
                interyvaluesplan1a = outp3
                x = interxvaluesplan1a
                y= interyvaluesplan1a
               # ax.plot(interxvaluesplan1a,interyvaluesplan1a, c='m')
                dose1 =interxvaluesplan1a
                #vol1 = interyvaluesplan1a            
            elif plan1files ==2:
                interxvaluesplan1b = np.add(outp1,outp2)
                x = interxvaluesplan1b
                interyvaluesplan1b = np.concatenate((outp3,outp10), axis=0)
                sort21 = np.sort(interyvaluesplan1b)
                vol21 = sort21[::-1]
                delta17 = (len(vol21)-1) / float(new_len-1)
                outp17 = [interpolate(vol21, i*delta17) for i in range(new_len)]
                y = outp17
                dose1 =interxvaluesplan1b
            
            elif plan1files ==3:
                interxvalues1plan1a = np.add(outp1,outp2)
                interxvaluesplan1c = np.add(interxvalues1plan1a, outp4)
                x = interxvaluesplan1c
                interyvalues1plan1a = np.concatenate((outp3,outp10),axis=0)
                interyvaluesplan1c = np.concatenate((interyvalues1plan1a,outp11),axis=0)
                sort31 = np.sort(interyvaluesplan1c)
                vol31 = sort31[::-1]
                delta19 = (len(vol31)-1) / float(new_len-1)
                outp19 = [interpolate(vol31, i*delta19) for i in range(new_len)]
                y = outp19
                dose1 =interxvalues1plan1a
            
            elif plan1files ==4:
                interxvalues1plan1b = np.add(outp1 , outp2)
                interxvalues2plan1a = np.add(outp4, outp5) 
                interxvaluesplan1d = np.add(interxvalues1plan1b, interxvalues2plan1a)
                x = interxvaluesplan1d
                interyvalues1plan1b = np.concatenate((outp3,outp10), axis=0)
                interyvalues2plan1a = np.concatenate((outp11, outp12), axis =0)
                interyvaluesplan1d = np.concatenate((interyvalues1plan1b, interyvalues2plan1a),axis=0)
                sort41 = np.sort(interyvaluesplan1d)
                vol41 = sort41[::-1]
                delta21 = (len(vol41)-1) / float(new_len-1)
                outp21 = [interpolate(vol41, i*delta21) for i in range(new_len)]
                y = outp21
                dose1 =interxvaluesplan1d

            else:
                print("please check line 650")

            if plan2files ==1:
                interxvaluesplan2a = outp6
                interyvaluesplan2a = outp13
                a = interxvaluesplan2a
                b = interyvaluesplan2a
                #ax.plot(interxvaluesplan2a,interyvaluesplan2a, c='b')
                dose2 =interxvaluesplan2a
               # vol2 = interyvaluesplan2a
            
            elif plan2files ==2:
                interxvaluesplan2b = np.add(outp6,outp7)
                a = interxvaluesplan2b
                interyvaluesplan2b = np.concatenate((outp13,outp14), axis=0)
                sort22 = np.sort(interyvaluesplan2b)
                vol22 = sort22[::-1]
                delta18 = (len(vol22)-1) / float(new_len-1)
                outp18 = [interpolate(vol22, i*delta18) for i in range(new_len)]
                b = outp18
                dose2 =interxvaluesplan2b
            
            elif plan2files ==3:
                interxvalues1plan2a = np.add(outp6,outp7)
                interxvaluesplan2c = np.add(interxvalues1plan2a, outp8)
                a = interxvaluesplan2c
                interyvalues1plan2a = np.concatenate((outp13, outp14), axis=0)
                interyvaluesplan2c = np.concatenate((interyvalues1plan2a, outp15), axis=0)
                sort32 = np.sort(interyvaluesplan2c)
                vol32 = sort32[::-1]
                delta20 = (len(vol32)-1) / float(new_len-1)
                outp20 = [interpolate(vol32, i*delta20) for i in range(new_len)]
                b = outp20
                dose2 =interxvaluesplan2c
        
            elif plan2files ==4:
                interxvalues1plan2b = np.add(outp6 , outp7)
                interxvalues2plan2a = np.add(outp8, outp9) 
                interxvaluesplan2d = np.add(interxvalues1plan2b, interxvalues2plan2a)
                a = interxvaluesplan2d
                interyvalues1plan2b = np.concatenate((outp13 , outp14),axis=0)
                interyvalues2plan2a = np.concatenate((outp15, outp16), axis=0)
                interyvaluesplan2d = np.concatenate((interyvalues1plan2b, interyvalues2plan2a), axis=0)
                sort42 = np.sort(interyvaluesplan2d)
                vol42 = sort42[::-1]
                delta22 = (len(vol42)-1) / float(new_len-1)
                outp22 = [interpolate(vol42, i*delta22) for i in range(new_len)]
                b = outp22
                dose2 =interxvaluesplan2d
            ...
            array = np.linspace(0, 100, 3000, endpoint=False)
            ...
            #     interxvalues = np.concatenate((outp1, outp6), axis =0)
            #     interyvalues = np.concatenate((outp3,outp13), axis=0)
            # elif plan1files==2 and plan2files ==2:
            #     interxvalues = np.add(interxvaluesplan1b, interxvaluesplan2b)
            #     interyvalues = np.concatenate((interyvaluesplan1b, interyvaluesplan2b), axis=0)
            # elif plan1files==3 and plan2files ==3:
            #     interxvalues = np.add(interxvaluesplan1c, interxvaluesplan2c)
            #     interyvalues = np.concatenate((interyvaluesplan1c, interyvaluesplan2c), axis=0)
            # elif plan1files==4 and plan2files==4:
            #     interxvalues = np.add(interxvaluesplan1d, interxvaluesplan2d)
            #     interyvalues = np.concatenate((interyvaluesplan1d, interyvaluesplan2d), axis=0)
            # elif plan1files==1 and plan2files ==2:
            #     interxvalues = np.add(outp1,interxvaluesplan2b)
            #     interyvalues = np.concatenate((outp3,interyvaluesplan2b), axis=0)
            # elif plan1files==1 and plan2files ==3:
            #     interxvalues = np.add(outp1,interxvaluesplan2c)
            #     interyvalues = np.concatenate((outp3,interyvaluesplan2c), axis=0)
            # elif plan1files==1 and plan2files ==4:
            #     interxvalues = np.add(outp1, interxvaluesplan2d)
            #     interyvalues = np.concatenate((outp3,interyvaluesplan2d), axis=0)
            # elif plan1files==2 and plan2files==1:
            #     interxvalues = np.add(interxvaluesplan1b, outp6)
            #     interyvalues = np.concatenate((interyvaluesplan1b, outp13), axis=0)
            # elif plan1files==3 and plan2files==1:
            #     interxvalues = np.add(interxvaluesplan1c, outp6)
            #     interyvalues = np.concatenate((interyvaluesplan1c, outp13), axis=0)
            # elif plan1files==4 and plan2files==1:
            #     interxvalues = np.add(interxvaluesplan1d, outp6)
            #     interyvalues = np.concatenate((interyvaluesplan1d, outp13), axis=0)
            # elif plan1files==2 and plan2files==3:
            #     interxvalues = np.add(interxvaluesplan1b, interxvaluesplan2c)
            #     interyvalues = np.concatenate((interyvaluesplan1b, interyvaluesplan2c), axis=0)
            # elif plan1files==2 and plan2files==4:
            #     interxvalues = np.add(interxvaluesplan1b, interxvaluesplan2d)
            #     interyvalues = np.concatenate((interyvaluesplan1b, interyvaluesplan2d), axis=0)
            # elif plan1files==3 and plan2files==4:
            #     interxvalues = np.add(interxvaluesplan1c, interxvaluesplan2d)
            #     interyvalues = np.concatenate((interyvaluesplan1c, interyvaluesplan2d), axis=0)
            # elif plan1files==4 and plan2files==3:
            #     interxvalues = np.add(interxvaluesplan1d, interxvaluesplan2c)
            #     interyvalues = np.concatenate((interyvaluesplan1d, interyvaluesplan2c), axis=0)
            # else:
            #     print("error")

            #set volume array to use for dose interpolation#
            inter1 = np.interp([array], xp1, fp1)#interpolation of plan1 dose
            reshapeinter1 = np.reshape(inter1,(3000,1))
            inter2 = np.interp([array], xp2, fp2)#interpolation of plan2 dose
            reshapeinter2 = np.reshape(inter2, (3000, 1))
            xvalues = reshapeinter1 + reshapeinter2 #adding plan1 and plan2 dose
            #reshapeyvals1 = np.reshape(xp1, (3000,1))
            #reshapeyvals2 = np.reshape(xp2, (3000,1))
            #yvalues = reshapeyvals1 + reshapeyvals2 # adding plan1 and plan2 volume
            reshapearray = np.reshape(array,(3000,1))#array of specified %volume in 0.1% intervals
            
           # ax.plot(dosefinaldata, volumefinaldata, c='y')
            ax.plot(xvalues,reshapearray,c='r')
            ax.legend(["Plan 1","Plan 2","Plan 1+2 EQD2"])
...
window.mainloop()
#ValueError: x and y must have same first dimension, but have shapes (3000,) and (9000,)